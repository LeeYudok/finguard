...
- [룰 검증용 실코드 코퍼스](project_finguard-scan-corpus.md) — 국내 금융 Swift/Kotlin 고스타 레포는 없음, 대안 10개 목록과 테스트코드 1차 필터·룰 고정 요령, `/tmp` 코퍼스 증발 함정
- [반박검증 재확인](project_adversarial-verify-recheck.md) — 검증자의 "실측했다" 주장도 대조군 세워 재현한 뒤에만 구현 근거로 쓴다
